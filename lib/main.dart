...
import 'package:flutterappdemo/utils/logger.dart';
import 'package:flutterappdemo/utils/net_utils.dart';
import 'package:flutterappdemo/utils/provider.dart';
...
MethodChannel AndroidApi = const MethodChannel("Android/api");
SpUtil sp;
...
void main() async {
  ...
  AndroidApi.setMethodCallHandler((MethodCall methodCall) {});
}
