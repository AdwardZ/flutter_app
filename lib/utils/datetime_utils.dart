...
class DateTimeUtils {
  static String format(DateTime datetime, {format = formatDate}) {
  ...
  static String formatTime(DateTime datetime, {format = formatDatetime}) {
    return DateFormat(format).format(datetime);
  }
  ...
  static DateTime getFirstDayOfWeek(DateTime dateTime) {
    return dateTime.add(Duration(days: 1 - dateTime.weekday));
  }
  ...
  static DateTime string4DateTime(String date, String format) {
